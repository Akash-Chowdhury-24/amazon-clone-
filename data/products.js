...
class Product {
  ...
  getPrice(){
    return `$${ProperRepresentCurrency(this.priceCents)}`
  }
...
export function loadProductsFetch(){
  const promise = fetch(
    ...
    products = data.map(function(productDetails){
...
// export function loadProducts(functionToBeCalled){
//   const xhr = new XMLHttpRequest();

//   xhr.addEventListener('load',function(){
//     products=JSON.parse(xhr.response).map(function(productDetails){
//       if(productDetails.type === "clothing"){
//         return new Clothing(productDetails);
//       }
//       if(productDetails.type === "appliance"){
...
// loading from the given data set 
/*
